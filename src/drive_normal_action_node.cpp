...
private:
  void do_work() override{
    ...
    if (progress_ < 1.0) {
      ...
      finish(true, 1.0, "Taxi move drive_normal completed");
    ...
    std::cout << "Taxi moving drive_normal from " << from_ << " to " << to_ << " [" 
...
int main(int argc, char ** argv){
  ...
  auto node = std::make_shared<MoveAction>("drive_normal", 250ms);
